...
import { AntDesign, Entypo, Feather, FontAwesome, FontAwesome5, FontAwesome6, Foundation, Ionicons, MaterialCommunityIcons, MaterialIcons, Octicons, SimpleLineIcons } from "@expo/vector-icons";
...
const CustomIcon = ({ iconLibraryType, color = "#6b7280", size = 20, style,iconName }: IconProps) => {
  switch (iconLibraryType) {
    ...
    case "FontAwesome6":
      return <FontAwesome6 name={iconName as keyof typeof FontAwesome["glyphMap"]} size={size} color={color??"black"} style={style} />;    
    case "Feather":
